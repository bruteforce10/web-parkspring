        ...
        <div className="flex max-lg:gap-12 max-lg:flex-col max-lg:justify-center max-lg:items-center items-start">
          <div className="flex flex-col gap-6">
            ...
            <button
              ...
              className="flex gap-4 max-lg:mx-auto text-white items-center w-fit text-lg border-gray-50 bg-white/5 border-2 backdrop-blur-xl shadow-sm lg:font-semibold before:absolute before:w-full relative z-10 px-8 py-3 overflow-hidden  rounded-full group max-sm:text-base max-sm:px-4 max-sm:py-2"
            >
              ...
              >
                <path
                  ...
                  className="fill-gray-50 group-hover:fill-gray-800/30"
                ></path>
              </svg>
            </button>
          </div>
